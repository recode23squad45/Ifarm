...
<head>
    ...
    <title>Lista de Empresas Parceiras - iFarm</title>
...
<body>
    ...
    <div class="container mt-5">
        <h1 class="text-center mb-4">Lista de Empresas Parceiras</h1>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <c:forEach var="empresa" items="${requestScope.empresasParceiras}">
                    <tr>
                        <td>${empresa.cnpj}</td>
                        <td>${empresa.nomeEmpresa}</td>
                        <td>${empresa.contatoEmpresa}</td>
                        <td>
			                <form action="/Ifarm/empresas_parceiras?delete=${empresa.cnpj}" method="post">
